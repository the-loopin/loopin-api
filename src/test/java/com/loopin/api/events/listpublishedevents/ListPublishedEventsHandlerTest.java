...
class ListPublishedEventsHandlerTest {
    ...
    void handle_preservesPaginationAndLoadsPageInterestsInListingOrder() {
        ...
        ListPublishedEventsHandler handler = new ListPublishedEventsHandler(
                repository, mapper, new PublishedEventSpecifications());
        ...
        when(repository.findPublishedByIdInWithInterests(List.of(1L, 2L)))
        ...
        var result = handler.handle(new ListPublishedEventsQuery(
                EventType.EVENT, EventCategory.TECH, "Baku", false, "meetup", null, null, pageable));
