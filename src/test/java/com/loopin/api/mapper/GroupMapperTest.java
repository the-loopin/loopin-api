...
class GroupMapperTest {
    ...
    void toEntity_ValidRequest_MapsFieldsAndSetsOpenStatus() {
        ...
        request.setGroupSize(com.loopin.api.common.enums.GroupSizeType.FOUR);
        ...
        assertEquals(com.loopin.api.common.enums.GroupSizeType.FOUR, group.getGroupSize());
    ...
    void toGroupResponse_ValidGroupWithEvent_MapsFieldsAndUsesPublicId() {
        ...
        group.setGroupSize(com.loopin.api.common.enums.GroupSizeType.FOUR);
        ...
        assertEquals(com.loopin.api.common.enums.GroupSizeType.FOUR, response.getGroupSize());
