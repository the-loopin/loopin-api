...
import { compactSummary, sharedThresholds, spikeScenario } from './helpers/config.js';
...
export default function (state) {
  ...
  sleep(Math.random() * 0.75 + 0.1);
}

export function handleSummary(data) {
  return compactSummary(data, 'spike');
}