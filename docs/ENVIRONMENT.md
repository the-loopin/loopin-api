...
| `LOOPIN_AI_EMBEDDING_JOBS_ENABLED` | Enables durable embedding-job workers. Job creation remains transactional. | `true` | The default local Compose stack overrides this to `false` because it does not include loopin-ai. |
